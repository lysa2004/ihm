...
public class LangueF extends JFrame {
    ...
    private void initializeQuestions() {
        questions = new ArrayList<>();
                 ...
                 List<String> choices1 = List.of("Espagnol ", "Hindi", "Anglais", "Polonais");
                 questions.add(new Question("Quelle langue parle-t-on en Angleterre."+
                " Avec des mots comme 'hello' et 'forever'?"+
                " Une langue mondiale, c'est certain."+
                " Peux-tu deviner laquelle, petit malin?", choices1, "Anglais"));

                List<String> choices2 = List.of("Russe", "Le grec", "Arabe", "Allemand");
                questions.add(new Question("Je suis une vieille langue de la Grèce ,"+
                "  mon alphabet a des lettres uniques en place."+
                " Socrate et Aristote me parlaient avec sagesse."+
                " Quelle est cette langue ancienne et pleine d'adresse?", choices2, "Le grec"));
        
                List<String> choices3 = List.of("Français", "Turc", "Malais", "Italien");
                questions.add(new Question("À l'école, on m'apprend avec amour. " +
                        "Au Niger, dans les rues, je suis partout. " +
                        "Molière, grand auteur, a écrit en moi."+
                        "Quelle est cette langue, peux-tu la deviner ?" , choices3, "Français"));
        
                List<String> choices4 = List.of("Suédois", "Arabe", "Chinois", "Russe");
                questions.add(new Question("Dans l'Arabie Saoudite, mes mots sont roi , " +
                        "Les lettres brillent comme des étoiles dans le bois . " +
                        "Salam Aleikum, une salutation en clarté . "+
                        "Quelle est cette langue, douce comme une lecture du Coran ?", choices4, "Arabe"));
        
                List<String> choices5 = List.of("Coréen", "Russe", "Turc", "Anglais");
                questions.add(new Question("En Australie, on parle une langue bien connue. "+
                      "Les kangourous sautent, les vagues sont émues."+
                      "est aussi celle de Shakespeare et de la Reine."+
                        "Quelle est cette langue, peux-tu deviner ?", choices5, "Anglais"));
    }
...
private void openPage1() {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(LangueF ::new);
    }
