...
public class Page2 extends JFrame implements ActionListener{
	...
	Page2(String fname , JLabel myJLabel) {
       ...
       //this.myLabel = myLabel;
		this.fname = fname;
		JLabel head = new JLabel("Bienvenu " + fname + " a GeoKids");
        ...
        sujet.setFont(new Font("Arial", Font.BOLD, 17));
        sujet.setForeground(Color.BLACK);
        sujet.setBounds(1040, 355,600, 100);   //(lemplacment horizentale , verticale , tban ga3 el kelma)
        add (sujet);
